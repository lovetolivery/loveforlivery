    ...
    if (!!settings.form && settings.form.isNeeded) {
        ...
        if ($('.order_form').length == 0) {
            ...
            $(window).scroll(function () {
                var timerOffset = $('.frm').offset().top - $(window).height() * 1.5;
